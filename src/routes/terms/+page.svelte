...
<!-- Breadcrumb start -->
    <section class="">
        <div class="overlay">
            <div class="container-fruid">
                <div class="breadcrumb-section overflow-hidden">
                    <div class="col-lg-12">
                        <div class="main-content flex items-center flex-wrap gap-3 justifybetween">
    ...
    <section class=" pb-120">
        <div class="privacy-content support-section mt-5">
            <div class="container-fruid">
